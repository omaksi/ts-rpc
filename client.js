...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var HelloWorld = () => {
    const [hello, setHello] = (0, import_react.useState)("");
    (0, import_react.useEffect)(() => {
      const fetchHelloWorld = async () => {
        const helloWorldResult = await Call("hello", { world: "Neptune" });
        setHello(helloWorldResult.message);
      };
      fetchHelloWorld();
    }, []);
    return /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h1", null, hello));
  };
  var domContainer = document.querySelector("#root");
  import_react_dom.default.render(import_react.default.createElement(HelloWorld), domContainer);
})();
/*
object-assign
(c) Sindre Sorhus
